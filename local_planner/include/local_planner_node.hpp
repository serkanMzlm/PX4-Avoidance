...
namespace avoidance
{
    ...
    {
        std::string topic_;
        rclcpp::Subscription<sensors_msgs::msg::PointCloud2>::SharedPtr pointcloud_sub_
            pcl::PointCloud<pcl::PointXYZ>
                untransformed_cloud_;
        bool received_;
    ...
    class LocalPlannerNodelet : public rclcpp::Node
    {
    public:
        LocalPlannerNodelet();
        ...
        std::unique_ptr<rclcpp::AsyncSpinner> cmdloop_spinner_;
    ...
    private:
        ...
        rclcpp::Timer cmdloop_timer_;
        rclcpp::CallbackQueue cmdloop_queue_;

        // Publishers
        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr mavros_pos_setpoint_pub_;
        rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr mavros_vel_setpoint_pub_;
        rclcpp::Publisher<>::SharedPtr mavros_obstacle_free_path_pub_;
        rclcpp::Publisher<sensor_msgs::msg::LaserScan>::SharedPtr mavros_obstacle_distance_pub_;
        // rclcpp::Publisher<>::SharedPtr mavros_system_status_pub_;
        ...
        rclcpp::Subscription<>::SharedPtr clicked_point_sub_;
        rclcpp::Subscription<>::SharedPtr clicked_goal_sub_;
        rclcpp::Subscription<>::SharedPtr fcu_input_sub_;
        rclcpp::Subscription<>::SharedPtr goal_topic_sub_;
        rclcpp::Subscription<>::SharedPtr distance_sensor_sub_;

        rclcpp::CallbackQueue pointcloud_queue_;
        rclcpp::CallbackQueue main_queue_;

        rclcpp::Time start_time_;
        rclcpp::Time last_wp_time_;
        rclcpp::Time t_status_sent_;

        geometry_msgs::msg::PoseStamped goal_mission_item_msg_;
         ...
         **/
        void cameraInfoCallback(const sensor_msgs::msg::CameraInfo::ConstPtr &msg, int index);
        ...
        void cmdLoopCallback(const rclcpp::TimerEvent &event);
