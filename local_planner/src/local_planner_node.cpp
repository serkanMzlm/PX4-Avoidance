...
namespace avoidance
{
  ...
  LocalPlannerNodelet::LocalPlannerNodelet() : tf_buffer_(5.f), spin_dt_(0.1), Node("local_planner_node") {}
  ...
  void LocalPlannerNodelet::positionCallback(const geometry_msgs::msg::PoseStamped &msg)
  {
  ...
  void LocalPlannerNodelet::velocityCallback(const geometry_msgs::msg::TwistStamped &msg)
  {
  ...
  void LocalPlannerNodelet::cmdLoopCallback(const rclcpp::TimerEvent &event)
  {
  ...
  void LocalPlannerNodelet::clickedPointCallback(const geometry_msgs::msg::PointStamped &msg)
  {
  ...
  void LocalPlannerNodelet::pointCloudCallback(const sensor_msgs::msg::PointCloud2::ConstPtr &msg, int index)
  {
  ...
  void LocalPlannerNodelet::checkFailsafe(rclcpp::Duration since_last_cloud, rclcpp::Duration since_start, bool &hover)
  {
      ...
      bool waiting_on_cloud = false;
      {
        ...
        if (cameras_[index].received_)
        {
                                      ...
                                      fcu_transform))
          {
            ...
            pcl::transformPointCloud(maxima, maxima, fcu_transform);
